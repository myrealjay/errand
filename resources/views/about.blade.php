...
<div class="row ">
	<div class="col-sm-5 w3-light-grey spacer">
		<div class="text-justify">
			<div class="container">
				<p>&nbsp;</p>
				<h3>Our Mission</h3>
				<p>Our mission is to establish a standard and world – class courier and delivery services company that will make available a wide range of services and products as it relates to the service offerings in the global courier and delivery services industry at affordable prices to the residence of Lagos and other locations in Nigeria where we intend operating from.</p>
				<p>&nbsp;</p>
				<h3>Our Vision</h3>
				<p>Our vision is to build a courier and delivery services company that will have an active presence all over Nigeria.</p>
				<p>&nbsp;</p>
				<h3>About us</h3>
	...
	<div class="col-sm-7">
		<div class="w3-card container spacer">
			<div class="w3-container">
				...
				<h6>Dry cleaners n Delivery and Pick up</h6>
	...
	<div class="lbbg"><br/>
		<div class="container w3-center row">
			...
			<div class="col-sm-2"><i class="fa fa-mobile font-response"></i><br>User friendly platform</div>
			<div class="col-sm-2"><i class="fa fa-globe font-response"></i><br>Secure and speedy deliveries</div>
			<div class="col-sm-2"><i class="fa fa-credit-card font-response"></i><br>Easy payment system</div>
			<div class="col-sm-2"><i class="fa fa-cog font-response"></i><br>Excellent customer support</div>
			<div class="col-sm-2"><i class="fa fa-users font-response"></i><br>Trustworthy and reliable team</div>
		</div><br/>
	</div>
@endsection
